...
const api = {
    getSolicitudes: async () => {
        const response = await fetch(`${API_URL}/cooperativa-de-viviendas-apis/endpoint/solicitudes/obtener_solicitudes.php`);
...
function loadSolicitudes() {
    ...
    fetch(`${API_URL}/cooperativa-de-viviendas-apis/endpoint/solicitudes/obtener_solicitudes.php`)
        .then(res => res.json())
        .then(result => {
